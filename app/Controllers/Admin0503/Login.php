...
class Login extends BaseController
{
    ...
    public function login()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            session()->set($akun);
            return redirect()->to("admin0503/dashboard")->withCookies();
        }
    ...
    function lupapassword()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if (empty($err)) {
                ...
                $link = site_url("admin0503/resetpassword/?email=$email&token=$token");
                $attachment = "";
                $to = $email;
            ...
            return redirect()->to("admin0503/lupapassword");
        }
    ...
    function resetpassword()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if (!$this->validate($aturan)) {
                ...
                return redirect()->to('admin0503/login')->withCookies();
            }
        }
