...
<body>
            ...
            <form id="main-form" class="footer-subscribe-form mt-4 p-4" action="<?= site_url('home/submit') ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <div style="position: relative; width: 100%;">
                            <select id="tujuan-input" name="tujuan" class="form-select" style="width: 100%; font-size: 14px; padding: 0.5rem; box-sizing: border-box;">
                ...
                <div class="container">
                    <div class="row mt-3 g-2">
                        ...
                        <!-- Tombol Daftar -->
                        <div class="col-6 mb-3">
                            <button id="btn-daftar" class="btn btn-warning w-100" type="submit" style="margin-top: -30px;">
                ...
                <div class="row gy-5 cta-wrap d-flex flex-wrap-nowrap">
                    ...
                    <div class="col-lg-3 col-md-6 cta-single">
                        <div class="cta-info text-center wow fadeInLeft" data-wow-delay=".2s">
                            <h2 class="counter-item">
                                <span class="odometer d-inline-block" data-odometer-final="<?= $dailyVisitors ?>">.</span>
                            </h2>
                            <p>This Day</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 cta-single">
                        <div class="cta-info text-center wow fadeInLeft" data-wow-delay=".4s">
                            <h2 class="counter-item">
                                <span class="odometer d-inline-block" data-odometer-final="<?= $weeklyVisitors ?>">.</span>
                            </h2>
                            <p>This Week</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 cta-single">
                        <div class="cta-info text-center wow fadeInLeft" data-wow-delay=".6s">
                            <h2 class="counter-item">
                                <span class="odometer d-inline-block" data-odometer-final="<?= $yearlyVisitors ?>">.</span>
                            </h2>
                            <p>This Year</p>
                        </div>
                    </div>
    ...
    <script>
        ...
        function compressImage(canvas, maxWidth, maxHeight, quality = 0.7) {
            return new Promise((resolve) => {
                const img = new Image();
                img.src = canvas.toDataURL('image/png'); // Convert canvas to image data URL
                img.onload = () => {
                    const ratio = Math.min(maxWidth / img.width, maxHeight / img.height);
                    const newWidth = img.width * ratio;
                    const newHeight = img.height * ratio;

                    // Create a new canvas to draw the compressed image
                    ...
                    // Convert the compressed image to Blob
                    compressedCanvas.toBlob((blob) => {
                        resolve(blob);
                    }, 'image/jpeg', quality); // Use 'image/jpeg' for better compression
                };
            });
        }
        // Function to handle form submission
        document.getElementById('main-form').addEventListener('submit', async function(e) {
            // Menghindari submit form agar spinner muncul sebelum submit
            e.preventDefault();
            ...
            if (!nikInput.value) {
                validationErrors += 'NIK tidak boleh kosong.\n';
            }

            if (!tujuanInput.value) {
                validationErrors += 'Tujuan harus dipilih.\n';
            }
            ...
            try {
                ...
                // Menghentikan spinner dan mengaktifkan tombol kembali
